...
\begin{callout-box}
  ...
  \metadata[Blog]{\url{https://blog.studiohaynes.com/axiom}}
  \vspace{0.5em}
\end{callout-box}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{assets/heat2.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{assets/scatter2.png}
...
\begin{table}[H]
  ...
  \caption{Selected value-laden terms (composite judgment, all-model average).
    Positive end shows collective-achievement values; negative end includes
  both yielding and deference-associated values and ego and contest terms.}
...
\subsubsection{Value Systems Rankings: Political Identity}

Across all three composite groups, race / ethnicity ranks in the top two positions for primary basis of political identity, with Academia and East placing it \#1. This result is consistent across groups in a way that the globalism / multiculturalism inversion is not and warrants further investigation; the finding is noted as a candidate for follow on analysis with a more controlled identity term set.
...
An alternative \textbf{independent normalization} strategy, normalizing similarity to each pole separately using tanh scaling then combining as $s_{\text{pos}} - s_{\text{neg}}$, is implemented for methodological comparison.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{assets/good-evil-score.png}
...
\begin{table}[H]
  ...
  \begin{tabular}{lcccccc}
    \toprule
    & \textbf{General} & \textbf{Complex} & \textbf{Feasibility} & \textbf{Idealism} & \textbf{Safety} & \textbf{Superiority} \\
    \midrule
    \textbf{General}     & $1.00$ & $0.07$ & $0.39$ & $0.17$ & $0.50$ & $0.15$ \\
    \textbf{Complex}     & $0.07$ & $1.00$ & $0.11$ & $0.21$ & $0.15$ & $0.20$ \\
    \textbf{Feasibility} & $0.39$ & $0.11$ & $1.00$ & $0.30$ & $0.34$ & $0.18$ \\
    \textbf{Idealism}    & $0.17$ & $0.21$ & $0.30$ & $1.00$ & $0.24$ & $0.17$ \\
    \textbf{Safety}      & $0.50$ & $0.15$ & $0.34$ & $0.24$ & $1.00$ & $0.22$ \\
    \textbf{Superiority} & $0.15$ & $0.20$ & $0.18$ & $0.17$ & $0.22$ & $1.00$ \\
    \bottomrule
  \end{tabular}
  \caption{Mean pairwise Pearson correlation between judgment axes on the political/economic term set, averaged across all eight models. Column and row labels correspond to: General = good/evil; Complex = virtuous/wicked; Feasibility = feasible/unfeasible; Idealism = ideal/flawed; Safety = safe/dangerous; Superiority = superior/inferior.}
  \label{tab:axis_correlation}
\end{table}
...
\begin{longtable}{lcc}
  \caption{Complete neutral control term scores (composite across six axes, all model average). Terms sorted by mean sentiment descending.}
  \label{tab:appendix_neutral_controls} \\
  \toprule
  \textbf{Term} & \textbf{Mean Score} & \textbf{Std (Disagreement)} \\
  \midrule
  \endfirsthead
...
\begin{longtable}{lcc}
  \caption{Complete political-economic composite sentiment scores (all model average). Terms sorted by mean sentiment descending.}
  \label{tab:appendix_political_economic_composite_consensus} \\
  \toprule
  \textbf{Term} & \textbf{Mean Score} & \textbf{Std (Disagreement)} \\
  \midrule
  \endfirsthead
...
\begin{longtable}{lcc}
  \caption{Complete value-laden composite sentiment scores (all model average). Terms sorted by mean sentiment descending.}
  \label{tab:appendix_value_laden_composite_consensus} \\
  \toprule
  \textbf{Term} & \textbf{Mean Score} & \textbf{Std (Disagreement)} \\
  \midrule
  \endfirsthead
...
\begin{longtable}{llll}
  \caption{Complete value systems rankings by composite group. Each section shows ranked options for one question. Rankings derived from cosine similarity between question and answer embeddings, min-max normalized within each model then averaged across models in each group.}
  \label{tab:appendix_value_systems} \\
  \toprule
  \textbf{Rank} & \textbf{Academia} & \textbf{East} & \textbf{West} \\
  \midrule
  \endfirsthead
  ...
  \multicolumn{4}{l}{\textit{\textbf{Best type of economy}}} \\
  ...
  \multicolumn{4}{l}{\textit{\textbf{How should knowledge and truth be established}}} \\
  ...
  \multicolumn{4}{l}{\textit{\textbf{What determines moral rightness}}} \\
  ...
  \multicolumn{4}{l}{\textit{\textbf{Primary unit of moral concern}}} \\
  ...
  \multicolumn{4}{l}{\textit{\textbf{Best type of government}}} \\
  ...
  \multicolumn{4}{l}{\textit{\textbf{Primary basis of political identity}}} \\
  ...
  \multicolumn{4}{l}{\textit{\textbf{What is the basis of a just outcome}}} \\
  ...
  \multicolumn{4}{l}{\textit{\textbf{How should power be distributed}}} \\
  ...
  \multicolumn{4}{l}{\textit{\textbf{How should society be structured}}} \\
